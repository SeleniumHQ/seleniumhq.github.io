...
[page load strategy]({{< ref "/webdriver/page_loading_strategy.ko.md" >}})
...
the [_WebElement_]({{< ref "/webdriver/web_element.ko.md" >}}) interface—such
 ...
 and [_Mouse_]({{< ref "/support_packages/mouse_and_keyboard_actions_in_detail.ko.md" >}}),
