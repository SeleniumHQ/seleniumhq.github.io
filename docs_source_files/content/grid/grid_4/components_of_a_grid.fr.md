...
The Router behaves differently depending on the request. The Router behaves differently depending on the request. 
...
more configuration details in the next [section]({{< ref "/grid/grid_4/setting_up_your_own_grid.fr.md" >}}).
