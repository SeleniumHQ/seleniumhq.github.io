...
def test_create_browsing_context_for_given_id(driver):
    ...
    browsing_context = driver.bidi_connection.bidi_session.browsing_context.create(context_id=id)
    assert browsing_context == id


@pytest.mark.driver_type("bidi")
def test_create_window(driver):
    browsing_context = driver.bidi_connection.bidi_session.browsing_context.create(type_hint=WindowTypes.WINDOW)
    assert browsing_context is not None


@pytest.mark.driver_type("bidi")
def test_create_tab(driver):
    browsing_context = driver.bidi_connection.bidi_session.browsing_context.create(type_hint=WindowTypes.TAB)
    assert browsing_context is not None
...
def test_navigate_to_url(driver):
    ...
    navigation_info = driver.bidi_connection.bidi_session.browsing_context.navigate(
...
def test_get_tree(driver):
    ...
    tree = driver.bidi_connection.bidi_session.browsing_context.get_tree(root=reference_context_id)
...
def test_close_window(driver):
    ...
    driver.bidi_connection.bidi_session.browsing_context.close(context=browsing_context)
...
def test_activate_browsing_context(driver):
    ...
    driver.bidi_connection.bidi_session.browsing_context.activate(context=browsing_context)
...
def test_reload_browsing_context(driver):
    ...
    navigation_info = driver.bidi_connection.bidi_session.browsing_context.reload(context=browsing_context)
