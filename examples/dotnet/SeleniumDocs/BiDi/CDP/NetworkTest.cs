...
namespace SeleniumDocs.BiDi.CDP
{
    ...
    public class NetworkTest : BaseTest
    {
        ...
        public async Task PerformanceMetrics()
        {
            ...
            var domains = session.GetVersionSpecificDomains<OpenQA.Selenium.DevTools.V136.DevToolsSessionDomains>();

            await domains.Performance.Enable(new OpenQA.Selenium.DevTools.V136.Performance.EnableCommandSettings());
            var metricsResponse =
        ...
        public async Task SetCookie()
        {
            var session = ((IDevTools)driver).GetDevToolsSession();
            var domains = session.GetVersionSpecificDomains<OpenQA.Selenium.DevTools.V136.DevToolsSessionDomains>();
            await domains.Network.Enable(new OpenQA.Selenium.DevTools.V136.Network.EnableCommandSettings());
