...
class MouseTest : BaseTest() {
    ...
    fun moveByOffsetFromViewport() {
        ...
        val mouse: PointerInput = PointerInput(PointerInput.Kind.MOUSE, "default mouse");

        val actions: Sequence = Sequence(mouse, 0)
    ...
    fun dragsByOffset() { 
        ...
        val draggable: WebElement = driver.findElement(By.id("draggable"));
        val start: Rectangle = draggable.getRect();
        val finish: Rectangle = driver.findElement(By.id("droppable")).getRect();
        Actions(driver)
