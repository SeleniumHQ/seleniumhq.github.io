...
[DomainDrivenDesign]({{< ref path="encouraged/domain_specific_language.md" lang="en" >}})：アプリのエンドユーザーの言語でテストを表現します。   
[PageObjects]({{< ref path="encouraged/page_object_models.md" lang="en" >}})：WebアプリのUIの単純な抽象化  
