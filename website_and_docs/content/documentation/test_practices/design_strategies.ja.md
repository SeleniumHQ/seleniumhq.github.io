...
{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/design_strategies/ProjectPage.java#L1-L38" >}}

and SecuredPage.java:

{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/design_strategies/SecuredPage.java#L1-L52" >}}
{{< /tab >}}
{{< tab header="CSharp" >}}
{{< badge-code >}}
{{< /tab >}}
...
{{< /tab >}}
{{< tab header="Java" >}}
{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/design_strategies/PageObjectTests.java#L1-L30" >}}
{{< /tab >}}
{{< tab header="CSharp" >}}
{{< badge-code >}}
{{< /tab >}}
