...
[DomainDrivenDesign](encouraged/domain_specific_language.en.md): Express your tests in the language of the end-user of the app.
[PageObjects](encouraged/page_object_models.en.md): A simple abstraction of the UI of your web app.
