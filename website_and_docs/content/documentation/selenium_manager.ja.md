...
{{% tab header="Java" %}}
**Previously**
{{< gh-codeblock path="examples/java/src/test/java/dev/selenium/selenium_manager/usage.java#L10-L15" >}}
**Selenium Manager**
{{< gh-codeblock path="examples/java/src/test/java/dev/selenium/selenium_manager/usage.java#L18-L22" >}}
{{< /tab >}}
{{% tab header="Python" %}}
**Previously**
