...
| `--hub` | string | `http://localhost:1234` | Configure event bus default to the default ports. Setting `--grid-url`,`--publish-events` and `--subscribe-events` flags to their default values.|
