...
* [オプション]({{< ref path="options.md" lang="en" >}}) 作成を希望するセッションの種類 ; ローカルにはデフォルト値を使用しますが、リモートには必須です。
...
{{% /tab %}}
{{< tab header="CSharp" >}}
{{< gh-codeblock path="/examples/dotnet/SeleniumDocs/BaseTest.cs#L49" >}}
{{< /tab >}}
{{< tab header="Ruby" >}}
...
詳細は、[リモートドライバー]({{< ref path="remote_webdriver.md" lang="en" >}})をご覧ください。
