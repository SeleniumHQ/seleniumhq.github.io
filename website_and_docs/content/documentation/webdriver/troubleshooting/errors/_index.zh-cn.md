...
* 确保您使用的是正确的 [等待策略]({{< ref path="/documentation/webdriver/waits" lang="en" >}})
...
[Explicit Waits]({{< ref path="/documentation/webdriver/waits" lang="en" >}}) will likely be your best friend 
