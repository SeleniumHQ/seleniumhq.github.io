...
{{< gh-codeblock path="/examples/python/tests/bidi/test_network_commands.py#L24-L29" >}}
{{< /tab >}}
{{< tab header="Ruby" >}}
{{< badge-code >}}
{{< /tab >}}
...
{{< tab header="Python" >}}
{{< badge-version version="4.32" >}}
{{< gh-codeblock path="/examples/python/tests/bidi/test_network_commands.py#L68-L88" >}}
{{< /tab >}}
{{< tab header="Ruby" >}}
{{< badge-code >}}
{{< /tab >}}
