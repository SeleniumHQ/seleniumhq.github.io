...
{{< tab header="Python" >}}
{{< badge-version version="4.32" >}}
{{< gh-codeblock path="/examples/python/tests/bidi/test_network_commands.py#L34-L58" >}}
{{< /tab >}}
{{< tab header="Ruby" >}}
{{< badge-code >}}
{{< /tab >}}
...
{{< tab header="Python" >}}
{{< badge-version version="4.32" >}}
{{< gh-codeblock path="/examples/python/tests/bidi/test_network_commands.py#L61-L72" >}}
{{< /tab >}}
{{< tab header="Ruby" >}}
{{< badge-code >}}
{{< /tab >}}
